...
//    	IStructurePieceType.register(RabbitVillageGenerator.Start::new, "RabbitVillage");
//    	IStructurePieceType.register(House::new, "RVBH");
//    	IStructurePieceType.register(Field::new, "RVDF");
//    	IStructurePieceType.register(Start::new, "RVStart");
//    	IStructurePieceType.register(Path::new, "RVSR");
//    	IStructurePieceType.register(Pen::new, "RVP");
//    }
//
...
//        list.add(new PieceWeight(House.class, 8, MathHelper.nextInt(random, 3, 5)));
//        list.add(new PieceWeight(Field.class, 5, MathHelper.nextInt(random, 3, 5)));
...
//    }
//
//    private static StructureRabbitVillagePieces.Village findAndCreateComponentFactory(StructureRabbitVillagePieces.Start start, StructureRabbitVillagePieces.PieceWeight weight, List<StructurePiece> StructurePieces, int structureMinX, int structureMinY, int structureMinZ, Direction facing, int componentType) {
//        return weight.villagePieceClass == House.class ? House.createPiece(start, StructurePieces, structureMinX, structureMinY, structureMinZ, facing, componentType) : weight.villagePieceClass == Field.class ? Field.createPiece(start, StructurePieces, structureMinX, structureMinY, structureMinZ, facing, componentType) : null;
//    }
//
//    private static StructureRabbitVillagePieces.Village generateComponent(StructureRabbitVillagePieces.Start start, List<StructurePiece> StructurePieces, Random rand, int structureMinX, int structureMinY, int structureMinZ, Direction facing, int componentType) {
...
//                            break;
//                        }
//                        StructureRabbitVillagePieces.Village piece = findAndCreateComponentFactory(start, weight, StructurePieces, structureMinX, structureMinY, structureMinZ, facing, componentType);
//                        if (piece != null) {
...
//    }
//
//    private static StructurePiece generateAndAddComponent(StructureRabbitVillagePieces.Start start, List<StructurePiece> StructurePieces, Random rand, int structureMinX, int structureMinY, int structureMinZ, Direction facing, int componentType) {
//        if (componentType > 50) {
//            return null;
//        } else if (Math.abs(structureMinX - start.getBoundingBox().minX) <= 112 && Math.abs(structureMinZ - start.getBoundingBox().minZ) <= 112) {
//            StructurePiece StructurePiece = generateComponent(start, StructurePieces, rand, structureMinX, structureMinY, structureMinZ, facing, componentType + 1);
//
...
//    }
//
//    private static void generateAndAddRoadPiece(StructureRabbitVillagePieces.Start start, List<StructurePiece> StructurePieces, Random rand, int structureMinX, int structureMinY, int structureMinZ, Direction facing, int type) {
...
//            MutableBoundingBox structureboundingbox = StructureRabbitVillagePieces.Path.findPieceBox(StructurePieces, rand, structureMinX, structureMinY, structureMinZ, facing);
//            if (structureboundingbox != null && structureboundingbox.minY > 10) {
//                StructurePiece component = new StructureRabbitVillagePieces.Path(start, type, structureboundingbox, facing);
//                StructurePieces.add(component);
...
//        }
//
//        Field(StructureRabbitVillagePieces.Start start, int type, MutableBoundingBox structureBoundingBox, EnumFacing facing) {
//            super(start, type);
//            this.setCoordBaseMode(facing);
//            this.boundingBox = structureBoundingBox;
//        }
//
//        static Field createPiece(StructureRabbitVillagePieces.Start start, List<StructurePiece> StructurePieces, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType) {
//            MutableBoundingBox structureboundingbox = MutableBoundingBox.getComponentToAddBoundingBox(structureMinX, structureMinY, structureMinZ, 0, 0, 0, 13, 4, 9, facing);
//            return canVillageGoDeeper(structureboundingbox) && StructurePiece.findIntersecting(StructurePieces, structureboundingbox) == null ? new Field(start, componentType, structureboundingbox, facing) : null;
//        }
//
//        public boolean addComponentParts(@Nonnull World worldIn, @Nonnull Random randomIn, @Nonnull MutableBoundingBox structureBoundingBoxIn) {
...
//        public House(){}
//
//        House(StructureRabbitVillagePieces.Start start, int type, MutableBoundingBox structureBoundingBox, EnumFacing facing) {
//            super(start, type);
//            this.setCoordBaseMode(facing.getOpposite());
//            this.boundingBox = structureBoundingBox;
//        }
//
//        static House createPiece(StructureRabbitVillagePieces.Start start, List<StructurePiece> StructurePieces, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType) {
//            MutableBoundingBox structureboundingbox = MutableBoundingBox.getComponentToAddBoundingBox(structureMinX, structureMinY, structureMinZ, 0, 0, 0, 9, 9, 6, facing);
//            return canVillageGoDeeper(structureboundingbox) && StructurePiece.findIntersecting(StructurePieces, structureboundingbox) == null ? new House(start, componentType, structureboundingbox, facing) : null;
//        }
//
//        public boolean addComponentParts(@Nonnull World worldIn, @Nonnull Random randomIn, @Nonnull MutableBoundingBox structureBoundingBoxIn) {
//            super.addComponentParts(worldIn, randomIn, structureBoundingBoxIn);
...
//            BlockState ladder = Blocks.LADDER.getDefaultState().withProperty(BlockLadder.FACING, EnumFacing.NORTH);
...
//        }
//
//        private void makeTable(World worldIn, int x, int y, MutableBoundingBox boundingBox) {
...
//        public Path(){}
//
//        Path(StructureRabbitVillagePieces.Start start, int type, MutableBoundingBox structureBoundingBox, EnumFacing facing) {
//            super(start, type);
//            this.setCoordBaseMode(facing);
//            this.boundingBox = structureBoundingBox;
...
//
//
//        public void buildComponent(StructurePiece componentIn, List<StructurePiece> StructurePieces, Random rand) {
//            boolean flag = false;
//
//            for (int i = rand.nextInt(5); i < this.length - 8; i += 2 + rand.nextInt(5)) {
//                StructurePiece component = this.getNextComponentNN((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, i);
//                if (component != null) {
...
//                StructurePiece component = this.getNextComponentPP((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, j);
//                if (component != null) {
...
//                    case NORTH:
//                    default:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
//                        break;
//                    case SOUTH:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
//                        break;
//                    case WEST:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.SOUTH, this.getComponentType());
//                        break;
//                    case EAST:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.SOUTH, this.getComponentType());
//                }
//            }
//
//            if (flag && rand.nextInt(3) > 0 && enumfacing != null) {
...
//                    case NORTH:
//                    default:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
//                        break;
//                    case SOUTH:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
//                        break;
//                    case WEST:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
//                        break;
//                    case EAST:
//                        StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
//                }
//            }
//        }
//
//         static MutableBoundingBox findPieceBox(List<StructurePiece> StructurePieces, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing) {
//            for (int i = 7 * MathHelper.getInt(rand, 3, 5); i >= 7; i -= 7) {
//                MutableBoundingBox structureboundingbox = MutableBoundingBox.getComponentToAddBoundingBox(structureMinX, structureMinY, structureMinZ, 0, 0, 0, 3, 3, i, facing);
//                if (StructurePiece.findIntersecting(StructurePieces, structureboundingbox) == null) return structureboundingbox;
//            }
//
//            return null;
//        }
...
//        List<StructurePiece> pendingHouses = new ArrayList<>();
//        List<StructurePiece> pendingRoads = new ArrayList<>();
//        Biome biome;
//
//        public Start(){}
//
...
//
//        Village(IStructurePieceType structurePieceTypeIn, int componentTypeIn) {
...
//
//        @Nullable
//        StructurePiece getNextComponentNN(StructureRabbitVillagePieces.Start start, List<StructurePiece> StructurePieces, Random rand, int x) {
//            EnumFacing facing = this.getCoordBaseMode();
//            if (facing != null) {
//                if (facing == EnumFacing.WEST) {
//                    return StructureRabbitVillagePieces.generateAndAddComponent(start, StructurePieces, rand, this.boundingBox.minX + x, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
//                }
//                return StructureRabbitVillagePieces.generateAndAddComponent(start, StructurePieces, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ + x, EnumFacing.WEST, this.getComponentType());
//            }
//            return null;
//        }
//
//        @Nullable
//        StructurePiece getNextComponentPP(StructureRabbitVillagePieces.Start start, List<StructurePiece> StructurePieces, Random rand, int x) {
//            EnumFacing facing = this.getCoordBaseMode();
//            if (facing != null) {
//                if (facing == EnumFacing.WEST) {
//                    return StructureRabbitVillagePieces.generateAndAddComponent(start, StructurePieces, rand, this.boundingBox.minX + x, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
//                }
//                return StructureRabbitVillagePieces.generateAndAddComponent(start, StructurePieces, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ + x, EnumFacing.EAST, this.getComponentType());
//            }
//            return null;
//        }
//
//        int getAverageGroundLevel(World worldIn, MutableBoundingBox structureBoundingBox) {
//            int i = 0;
//            int j = 0;
...
//        }
//
//        static boolean canVillageGoDeeper(MutableBoundingBox structureBoundingBox) {
//            return structureBoundingBox != null && structureBoundingBox.minY > 10;
//        }
//
//        void spawnRabbitmen(World worldIn, MutableBoundingBox structureBoundingBox) {
//            for (int i = 0; i < 2; ++i) {
...
//        }
//        
//        void createVillageDoor(World world, MutableBoundingBox structureBoundingBox, Random rand) {
...
//
//        public void buildComponent(StructurePiece componentIn, List<StructurePiece> StructurePieces, Random rand) {
//            StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
//            StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
//            StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
//            StructureRabbitVillagePieces.generateAndAddRoadPiece((StructureRabbitVillagePieces.Start) componentIn, StructurePieces, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
//        }
//
//        public boolean addComponentParts(@Nonnull World worldIn, @Nonnull Random randomIn, @Nonnull MutableBoundingBox structureBoundingBoxIn) {
//            super.addComponentParts(worldIn, randomIn, structureBoundingBoxIn);
...
//            this.setBlockState(worldIn, gate.with(FenceGateBlock.HORIZONTAL_FACING, Direction.NORTH), 3, 11, 1, structureBoundingBoxIn);
//            this.setBlockState(worldIn, gate.with(FenceGateBlock.HORIZONTAL_FACING, Direction.EAST), 1, 11, 3, structureBoundingBoxIn);
//            this.setBlockState(worldIn, gate.with(FenceGateBlock.HORIZONTAL_FACING, Direction.SOUTH), 3, 11, 5, structureBoundingBoxIn);
//            this.setBlockState(worldIn, gate.with(FenceGateBlock.HORIZONTAL_FACING, Direction.WEST), 5, 11, 3, structureBoundingBoxIn);
