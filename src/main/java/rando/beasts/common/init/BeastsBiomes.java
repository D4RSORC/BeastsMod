...
public class BeastsBiomes {
	...
	public static void addTypes(Biome biome, BiomeManager.BiomeType mainType, int weight, boolean stronghold,
			boolean village, BiomeDictionary.Type... types) {
	...
	public static void addTypes(Biome biome, BiomeManager.BiomeType mainType, int weight,
