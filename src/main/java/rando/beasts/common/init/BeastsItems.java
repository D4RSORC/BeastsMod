...
public class BeastsItems {
	...
	public static final Item COCONUT_BOWL = new BeastsItem("coconut_bowl", new Properties().group(BeastsItemGroup.MAIN).maxStackSize(2));
	...
	public static final Item HERMIT_HELM = new BeastsArmor("hermit_helm", ArmorMaterial.IRON, EquipmentSlotType.HEAD, new Properties().maxDamage(0));
	public static final Item COCONUT_MUSHROOM = new BeastsCoconutBowl("coconut_mushroom", BeastsFoods.COCONUT_MUSHROOM);
	public static final Item COCONUT_RABBIT_STEW = new BeastsCoconutBowl("coconut_rabbit_stew", BeastsFoods.COCONUT_RABBIT_STEW);
	public static final Item REEF_MIXTURE = new BeastsCoconutBowl("reef_mixture", BeastsFoods.REEF_MIXTURE, new EffectInstance(Effects.REGENERATION, 100, 0), new EffectInstance(Effects.WEAKNESS, 100, 0));
	...
	public static final ArmorItem SPARTAPOD_HELMET = new BeastsArmor("spartapod_helmet", BeastsArmorMaterial.SPARTAPOD, EquipmentSlotType.HEAD);
	public static final ArmorItem SPARTAPOD_CHEST = new BeastsArmor("spartapod_chest", BeastsArmorMaterial.SPARTAPODA, EquipmentSlotType.CHEST);
	public static final ArmorItem SPARTAPOD_LEGS = new BeastsArmor("spartapod_legs", BeastsArmorMaterial.SPARTAPODA, EquipmentSlotType.LEGS);
	public static final ArmorItem SPARTAPOD_BOOTS = new BeastsArmor("spartapod_boots", BeastsArmorMaterial.SPARTAPODA, EquipmentSlotType.FEET);
	...
	public static final SwordItem COOKED_DAGGERFISH = new BeastsSword(BeastsItemTier.SWORDFISH_TIER, "cooked_daggerfish", 3, -3.0F, new Properties().food(BeastsFoods.COOKED_DAGGERFISH), null);
