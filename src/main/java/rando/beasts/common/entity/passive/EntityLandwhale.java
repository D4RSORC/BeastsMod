...
public class EntityLandwhale extends AnimalEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new TemptGoal(this, 1.25D, Ingredient.fromItems(BeastsItems.REEF_MIXTURE), false));
