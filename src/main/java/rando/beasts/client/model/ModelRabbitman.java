...
public class ModelRabbitman extends EntityModel<EntityRabbitman> {
	...
	@Override
	public void render(EntityRabbitman entity, float f, float f1, float f2, float f3, float f4, float f5) {
		if (entity.isChild()) {
	...
	@Override
	public void setRotationAngles(EntityRabbitman entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
