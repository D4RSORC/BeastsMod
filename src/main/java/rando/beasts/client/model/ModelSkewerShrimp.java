...
public class ModelSkewerShrimp extends EntityModel<EntitySkewerShrimp> {
	...
	@Override
	public void setRotationAngles(EntitySkewerShrimp entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		this.leftWhisker.rotateAngleY = MathHelper.cos(3.15F - limbSwing * speed * 0.7F) * degree * limbSwingAmount
				* 0.5F;
