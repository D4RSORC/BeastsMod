...
public class ModelVileEel extends EntityModel<EntityVileEel> {
	...
	public void render(EntityVileEel entity, float f, float f1, float f2, float f3, float f4, float f5) {
		if (this.isChild) {
			...
			GlStateManager.translated(0.0F, 24.0F * f5, 1.65F * f5);
		}
		this.body.render(f5);
	}

	@Override
	public void setRotationAngles(EntityVileEel entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
