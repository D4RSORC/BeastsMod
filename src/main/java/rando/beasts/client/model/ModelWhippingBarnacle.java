...
public class ModelWhippingBarnacle extends EntityModel<EntityWhippingBarnacle> {
    ...
    @Override
    public void render(EntityWhippingBarnacle entity, float f, float f1, float f2, float f3, float f4, float f5) {
        this.body.render(f5);
    }


    @Override
    public void setRotationAngles(EntityWhippingBarnacle entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
        super.setRotationAngles(entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scaleFactor);
        EntityWhippingBarnacle barnacle = entityIn;
